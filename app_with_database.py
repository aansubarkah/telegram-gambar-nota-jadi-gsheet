...
class TelegramInvoiceBotWithDB:
    ...
    async def upgrade_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        upgrade_msg = (
            ...
            "• Price: IDR 100K/month\n\n"
            "🥇 GOLD\n"
            "• 150 images/day\n"
            "• Your own Google Sheet\n"
            "• Price: IDR 200K/month\n\n"
            "💫 PLATINUM\n"
            "• 300 images/day\n"
            "• Your own Google Sheet\n"
            "• Price: IDR 300K/month\n\n"
            "📞 To upgrade, please contact @basangdata with your Telegram ID.\n\n"
            f"Your Telegram ID: {update.effective_user.id}"
        )
        await update.message.reply_text(upgrade_msg)
